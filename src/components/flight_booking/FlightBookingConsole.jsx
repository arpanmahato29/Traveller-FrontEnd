    ...
    <form class="row g-3">
      <div className="row mb-3">
        <div className="col-5 me-2">
          <label for="departure" className="form-label text-muted">
            From
          </label>
        ...
        <div className="col-5 ms-2">
          <label for="arrival" className="form-label text-muted">
            To
          </label>
      ...
      <div className="row mb-3">
        <div className="col-3 me-1">
          <label for="departure-date" className="form-label text-muted">
            Dept Date
          </label>
          <input type="date" className="form-control" id="departure-date" />
        </div>
        <div className="col-3 me-1">
          <label for="return-date" className="form-label text-muted">
            Return Date
          </label>
      ...
      <div className="row mb-3">
        <div class="col-3 me-1">
          <label for="travel-class" class="form-label text-muted">
            Class
          </label>
        ...
        <div className="col-3 ">
          <label for="no-of-travellers" className="form-label text-muted">
            Travellers
          </label>
          <input
            list="traveller-count-list"
            type="text"
...
const OneWay = () => {
  return (
    <form class="row g-3">
      ...
      <div className="row mb-3">
        <div className="col-3 me-1">
          <label for="departure-date" className="form-label">
            Dept Date
          </label>
          <input type="date" className="form-control" id="departure-date" />
        </div>
        <div class="col-3 me-1">
          <label for="travel-class" class="form-label">
            Class
          </label>
          <select id="travel-class" class="form-select">
            <option selected>Economy</option>
        ...
        <div className="col-3 ">
          <label for="no-of-travellers" className="form-label">
            Travellers
          </label>
          <input
            list="traveller-count-list"
